        ...
        <>
            ...
            <Card className="gx-card ">
                <div className="gx-bg-grey gx-px-5 gx-py-2 gx-bg-flex gx-align-items-center">
                    <span className="gx-fs-xl gx-font-weight-normal gx-text-white gx-align-items-center gx-text-uppercase">Company Report<br />
                        <p className="gx-fs-md gx-text-uppercase">{matchName}</p></span>
                    <Button onClick={() => onChange(parentId)} type="primary">Back</Button>
                </div>
                <div className="gx-p-3">
                    <Table
                        className="gx-text-uppercase gx-fs-md gx-font-weight-bold"
                        columns={columns}
