...
const BTX99MatchDetails = () => {
  ...
  useEffect(() => {
    if (sportsBetsList) {
      const { oddsBetData, fancyBetData, totalOddsCount, totalFancyCount } =
        sportsBetsList?.data;
...
useEffect(() => {
  ...
  const columns = [
    {
          ...
          <div style={{ display: "flex " }}>
            ...
            <div
              style={{
                padding: "6px 8px",
                cursor: "pointer",
                backgroundColor: activesubTab === 1 ? "#eb6d88" : "#fff",

                color: activesubTab === 1 ? "white" : "black ",
              }}
            ...
            <div
              style={{
                padding: "6px 8px",
                cursor: "pointer",
                backgroundColor: activesubTab === 2 ? "#eb6d88" : "#fff",
                color: activesubTab === 2 ? "white" : "black",
              }}
      ...
      render: (text, record, index) => (
        <div className="">
          ...
          <div className={`${-1 * record?.position > 0 ? 'gx-text-primary' : 'gx-text-red'} `} >
    ...
    },
    {
      ...
      onHeaderCell: (column) => ({
        style: {
          backgroundColor: column.key === "lgaai" ? "white" : "",
          color: column.key === "lgaai" ? "blue" : "",
        },
      }),
      className: "",
      align: "center",
      render: (text, record, index) => <div className="gx-font-weight-semi-bold gx-text-blue">
    ...
    },
    {
      ...
      onHeaderCell: (column) => ({
        style: {
          backgroundColor: column.key === "khaai" ? " white" : "",
          color: column.key === "khaai" ? " red" : "",
        },
      }),
      key: "khaai",
      width: "20%",
      align: "center",
      render: (text, record, index) => <div className="gx-font-weight-semi-bold gx-text-red">
        {(Number(text) * 100).toFixed(0)}
      </div>,
    },
  ];
  ...
  const oddsColumn = [
    {
      ...
      render: (text, record, index) => (
        <div className="">
          <div className=" gx-font-weight-semi-bold gx-text-uppercase">{text}</div>
          <div className={`gx-font-weight-semi-bold ${(record?.oddsposition ? -1 * record?.oddsposition : 0) >= 0 ? "gx-text-primary" : "gx-text-red"}`} >{record?.oddsposition ? (-1 * record?.oddsposition.toFixed(2)) : 0}</div>
        </div>
      ),
    }
    ,
  ...
  const tiedColumn = [
    {
      ...
      render: (text, record, index) => (
        <div className="">
          <div className=" gx-font-weight-semi-bold gx-text-uppercase">{text}</div>
          <div className={`gx-font-weight-semi-bold  ${(record?.tiedposition ? record?.tiedposition : 0) >= 0 ? 'gx-text-primary' : 'gx-text-red'} `}>{record?.tiedposition ? record?.tiedposition : 0}</div>
        </div>
      ),
    }
    ,
  ...
  const tossColumn = [
    ...
    ,
    {
      ...
      align: "center",
      render: (text, record, index) => (
        <div className="gx-font-weight-semi-bold gx-bg-flex gx-flex-column gx-text-blue">
          <span>
    ...
    },
    {
      ...
      onHeaderCell: (column) => ({
        style: {
          backgroundColor: column.key === "lgaai" ? "white" : "",
          color: column.key === "lgaai" ? "red" : "",
        },
      }),
      className: "",
      align: "center",
      render: (text, record, index) => (
        <div className="gx-font-weight-semi-bold gx-bg-flex gx-flex-column gx-text-red">
          <span>
  ...
  const fancyColumns = [
    ...
    },
    {
      ...
      onHeaderCell: (column) => ({
        style: {
          backgroundColor: column.key === "oddsNo" ? " white" : "",
          color: column.key === "oddsNo" ? " red" : "",
        },
      }),
      render: (text, record) => {
        return record.running_status !== "SUSPENDED" ? (
          <div>
            <div className="gx-font-weight-semi-bold gx-text-red">{record.runsNo}</div>
    ...
    },
    {
      ...
      onHeaderCell: (column) => ({
        style: {
          backgroundColor: column.key === "oddsYes" ? "white" : "",
          color: column.key === "oddsYes" ? "blue" : "",
        },
      }),
      ...
      render: (text, record) => {
        return record.running_status !== "SUSPENDED" ? (
          <div>
            <div className="gx-font-weight-semi-bold gx-text-blue">{record.runsYes}</div>
            <div className="gx-font-weight-semi-bold gx-text-blue">
              {(Number(text) * 100).toFixed(0)}
            </div>
          </div>
        ) : (
  ...
  const NoCommfancyColumns = [
    {
      title: (
        <div className="gx-bg-flex gx-justify-content-between gx-px-1 gx-align-items-center">
          <span className="gx-px-1 gx-py-1 gx-bg-primary gx-text-nowrap ">No Comm Fancy</span>
          <span style={{ textWrap: "nowrap" }} >
  ...
  const runplcolumn = [
    ...
    },
    {
      ...
      dataIndex: "pnl",
      render: (text, record) => (
        <div className={`${Number(record?.pnl) > 0 ? "gx-text-green-0" : Number(record?.pnl) < 0 ? "gx-text-red" : "gx-text-black"}`}>
          {record?.pnl}
        </div>
  ...
  return (
    <div className="gx-px-1  gx-w-100 ">
      <Row
        style={{ backgroundColor: "#73766F" }}
        className="gx-bg-flex gx-justify-content-start gx-align-items-center gx-px-2 gx-py-1 "
      >
        <span
      ...
      {matchDetailsResponse?.scoreIframe || matchIframeUrl ? (
        <Row
          style={{ height: `${activeTabs.tab1 ? "270px" : "110px"}` }}
          className=""
        >
          <iframe
      ...
      <Row className="gx-px-0 gx-py-0">
        <div className="gx-bg-grey gx-w-100 gx-bg-flex gx-align-items-center gx-px-2 gx-py-2  gx-text-white">
          ...
          <div className=" gx-py-2 gx-px-3  gx-text-white gx-text-uppercase">
            <span className="gx-ml-2 gx-font-weight-semi-bold">OddsType</span>
            <Select className=" gx-pl-2  gx-bg-grey  "
              placeholder="Select a OddsType "
              showSearch
              optionFilterProp="children"
              onChange={onChangeBetList}
              style={{ width: 150 }}
            // dropdownStyle={{ background: 'blue' }}
            // filterOption={filterOption}
            >
              <Option className=""> All OddsType </Option>
...
{!activeFancy ? (
      ...
      <Row className="gx-px-0 gx-py-0 gx-my-3">
        {/* {completeDataLoading && <div className="gx-bg-flex  gx-justify-content-center gx-align-items-center" style={{ height: '100%' }}>
          <Row justify="center" align="middle" style={{ height: '100%', position: "fixed", top: "0", left: "50%" }} className="gx-full-height ">
            <Col>
        ...
        <div className="gx-bg-grey gx-w-100 gx-bg-flex gx-align-items-center gx-px-2 gx-py-3 gx-mb-1 gx-text-white">
          <span className="gx-fs-xl">{`Completed Fancy [${completedData?.length ? completedData?.length : 0}]`}</span>{" "}
          <Button
      ...
      <Row className="gx-px-0 gx-py-0 gx-my-1 gx-justify-content-center">
        <Button
        ...
        {/* <div className="gx-bg-grey gx-w-100 gx-fs-xl gx-px-2 gx-py-3 gx-mb-1 gx-text-white">
          More Events
        </div>
        {matchList &&
          matchList.length > 0 &&
          matchList.filter((ele) => {
            return ele.marketId !== marketId;
          })
            ?.map((ele) => {
              return (
                <div className=" gx-py-1 gx-my-2 gx-w-100 gx-px-2">
                  <Link
                    to={`/components/matchviewdetail/match-view-details/${ele.marketId}/${ele.eventId}`}
                  >
                    <div className="gx-text-grey">{ele.matchName}</div>
...
export default BTX99MatchDetails
