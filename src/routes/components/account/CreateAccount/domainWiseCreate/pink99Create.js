...
import { generateRandomPasswordCreate } from "../../../../../components/RandomPassword";
...
const Pink99Create = () => {
    ...
    const randomPassword = generateRandomPasswordCreate(6);
                    ...
                    {loading === false && showForm && (
                        <Card className="gx-card">
                            <div className="gx-bg-grey gx-px-5 gx-pt-3 gx-bg-flex">
                                <span className="gx-fs-2xl gx-font-weight-normal gx-text-white gx-align-items-center gx-pt-1 gx-text-capitalize">Create {userType === "subadmin" ? "mini admin" : userType}</span>
                                <BackButton />
                            </div>
                            <Form
                                ...
                                onFinish={onFinish}
                                name="register"
                                initialValues={{ password: randomPassword }}
                            ...
                            >
                                ...
                                <Row className="gx-bg-flex">
                                    ...
                                    <Col md={12} xs={24}>
                                        ...
                                        >
                                            <Input placeholder={`${userType === "subadmin" ? "mini admin" : userType} coins`} className="gx-border-redius0" />
                                        </Form.Item>
                                    </Col>
                                </Row>
                                <Row className="gx-bg-flex">
                                    ...
                                    <Col md={12} xs={24}>
                                        ...
                                        >
                                            <Input placeholder='Password' disabled className="gx-border-redius0" />
                                        </Form.Item>
                                    </Col>
                                </Row>
                              ...
                              <Input placeholder={`${userType} maxCommValue`} className="gx-border-redius0" />
                                ...
                                {userType === "client" ? null
                                    ...
                                    <Row className="gx-bg-flex">
                                        ...
                                        <Col md={12} xs={24}>
                                            ...
                                            >
                                                <Input placeholder={`${userType === "subadmin" ? "mini admin" : userType} Match Share`} className="gx-border-redius0" />
                                            </Form.Item>
                                        </Col>
                                    </Row>
                                }
                                    ...
                                    <>
                                        <Row className="gx-bg-flex">
                                            ...
                                            <Col md={12} xs={24}>
                                                ...
                                                >
                                                    <Input placeholder={`${userType === "subadmin" ? "mini admin" : userType} Match Commission`} className="gx-border-redius0" />
                                                </Form.Item>
                                            </Col>
                                        </Row>
                                        <Row className="gx-bg-flex">
                                            ...
                                            <Col md={12} xs={24}>
                                                ...
                                                >
                                                    <Input placeholder={`${userType === "subadmin" ? "mini admin" : userType} Session Commission`} className="gx-border-redius0" />
                                                </Form.Item>
                                            </Col>
                                        </Row>
                                    </>}
                                ...
                                {userType === "client" ? null :
                                    <Row className="gx-bg-flex">
                                        ...
                                        <Col md={12} xs={24}>
                                            ...
                                            >
                                                <Input placeholder={`${userType === "subadmin" ? "mini admin" : userType} casino share`} className="gx-border-redius0" />
                                            </Form.Item>
                                        </Col>
                                    </Row>}
                                ...
                                {userType === 'client' ? null : <>
                                    {internationalCasino === true && (
                                        <>
                                            <h1><span style={{ textTransform: "capitalize" }}> {userType === "subadmin" ? "mini admin" : userType} </span>International Casino Share</h1>
                                            <Form.Item
                                ...
                                {userType === 'client' ? null : <>
                                    {matkaVisible === true && (
                                        <>
                                            <h1><span style={{ textTransform: "capitalize" }}> {userType === "subadmin" ? "mini admin" : userType} </span>Matka Share</h1>
                                            <Form.Item
                                                name="matkaStatus"
                                                ...
                                                <Col md={12} xs={24}>
                                                    <Form.Item
                                                        ...
                                                        rules={[
                                                            ...
                                                            { required: true, message: "Please input your casino Share!" },]}
                                                    >
                                                        <Input placeholder={`Matka Share`} className="gx-border-redius0" />
                                                    </Form.Item>
                                                </Col>
                                            </Row>
                                            <Row className="gx-bg-flex">
