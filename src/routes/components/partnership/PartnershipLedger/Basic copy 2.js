              ...
              <Col lg={6} md={8} sm={12} xs={24} className="gx-px-5">
                <Form.Item label="Match Share">
                  <Input
                    ...
                    value={userShare?.matchShare === "" ? "" : 100 - userShare?.matchShare}
                ...
                <Form.Item label="casino Share">
                  <Input
                    placeholder="CasinoShare"
                     ...
                     value={userShare.casinoShare === "" ? "" : 100 - userShare.casinoShare}
                    onChange={
